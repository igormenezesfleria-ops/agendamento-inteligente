...
export default function AdminRequests() {
  ...
  const { data: requests, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // 72h visibility filter: hide auto-generated "Aluno Fixo" appointments
      // until they are within 3 days (72 hours) of the class start time.
      ...
      const visible = appointments.filter((a) => {
        ...
        if (!isAutoGenerated) return true; // manual requests always visible
