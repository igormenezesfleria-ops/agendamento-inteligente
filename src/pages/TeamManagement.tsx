...
export default function TeamManagement() {
  ...
  const addCollaborator = async () => {
    ...
    try {
      // Create the user via edge function (to be created)
      ...
      toast({
        ...
        description: `${newCollaborator.name} foi adicionado à equipe.`,
      });
  ...
  const removeCollaboratorMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: 'O colaborador foi removido da equipe.',
      });
      queryClient.invalidateQueries({ queryKey: ['collaborators'] });
    },
    onError: (error: any) => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              Adicione ou remova colaboradores do seu studio.
            </p>
          </div>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewCollaborator({ ...newCollaborator, password: e.target.value })
                    }
                  />
                </div>
              </div>
        ...
        {isLoading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {collaborators.map((collaborator) => (
              <Card key={collaborator.id} className="card-hover">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <Badge variant="collaborator" className="mt-1">
                          Colaborador
                        </Badge>
                      </div>
                    </div>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Adicione membros à sua equipe para delegar treinos.
              </p>
